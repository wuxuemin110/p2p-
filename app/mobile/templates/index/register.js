...
angular.module('myApp.register', ['ngRoute'])
	...
	.config(['$routeProvider', function($routeProvider) {
		$routeProvider.when('/mobile/register', {
			templateUrl: 'mobile/templates/index/register.html',
			controller: 'RegisterCtrl'
		});
	}])

	.controller('RegisterCtrl',  function($scope, $http, $location, $mdDialog,$timeout,$interval, registerService, userOnlineBankService2) {
		$scope.registerInfo = {
			'user': {

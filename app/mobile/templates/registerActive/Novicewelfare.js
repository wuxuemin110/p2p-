...
angular.module('myApp.Novicewelfare', ['ngRoute'])
    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/mobile/Novicewelfare', {
            templateUrl: 'mobile/templates/registerActive/Novicewelfare.html',
            controller: 'Novicewelfare'
        });
    }])
    .controller('Novicewelfare', function ($scope, $http, $location, $mdDialog, shareRegisterService2, userOnlineBankService2) {

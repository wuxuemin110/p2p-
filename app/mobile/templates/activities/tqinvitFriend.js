 ...
 */
angular.module('myApp.tqinvitFriend', ['ngRoute'])
    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/mobile/tqinvitFriend', {
            templateUrl: 'mobile/templates/activities/tqinvitFriend.html',
            controller: 'tqinvitFriend'
        });
    }])
    .controller('tqinvitFriend', function($scope, $mdDialog, $location, $http) {
